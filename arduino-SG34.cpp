...
boolean SG34::begin(TwoWire &wirePort, uint32_t i2cSpeed, uint8_t i2caddr) {
...
void SG34::wakeUp(void) {
  // Pull IC out of low power mode (datasheet pg. 19)
  bitMask(MAX30105_MODECONFIG, MAX30105_SHUTDOWN_MASK, MAX30105_WAKEUP);
}

void SG34::setLEDMode(uint8_t mode) {
  // Set which LEDs are used for sampling -- Red only, RED+IR only, or custom.
  // See datasheet, page 19
  bitMask(MAX30105_MODECONFIG, MAX30105_MODE_MASK, mode);
}

void SG34::setADCRange(uint8_t adcRange) {
  // adcRange: one of MAX30105_ADCRANGE_2048, _4096, _8192, _16384
  bitMask(MAX30105_PARTICLECONFIG, MAX30105_ADCRANGE_MASK, adcRange);
}

void SG34::setSampleRate(uint8_t sampleRate) {
  // sampleRate: one of MAX30105_SAMPLERATE_50, _100, _200, _400, _800, _1000, _1600, _3200
  bitMask(MAX30105_PARTICLECONFIG, MAX30105_SAMPLERATE_MASK, sampleRate);
}

void SG34::setPulseWidth(uint8_t pulseWidth) {
...
void SG34::setPulseAmplitudeRed(uint8_t amplitude) {
  xCore.write8(_i2caddr, MAX30105_LED1_PULSEAMP, amplitude);
}

void SG34::setPulseAmplitudeIR(uint8_t amplitude) {
  xCore.write8(_i2caddr, MAX30105_LED2_PULSEAMP, amplitude);
}

void SG34::setPulseAmplitudeGreen(uint8_t amplitude) {
  xCore.write8(_i2caddr, MAX30105_LED3_PULSEAMP, amplitude);
}

void SG34::setPulseAmplitudeProximity(uint8_t amplitude) {
  xCore.write8(_i2caddr, MAX30105_LED_PROX_AMP, amplitude);
}

void SG34::setProximityThreshold(uint8_t threshMSB) {
...
void SG34::enableSlot(uint8_t slotNumber, uint8_t device) {
...
void SG34::setFIFOAverage(uint8_t numberOfSamples) {
  bitMask(MAX30105_FIFOCONFIG, MAX30105_SAMPLEAVG_MASK, numberOfSamples);
}

//Resets all points to start in a known state
//Page 15 recommends clearing FIFO before beginning a read
void SG34::clearFIFO(void) {
...
void SG34::enableFIFORollover(void) {
  bitMask(MAX30105_FIFOCONFIG, MAX30105_ROLLOVER_MASK, MAX30105_ROLLOVER_ENABLE);
}

//Disable roll over if FIFO over flows
void SG34::disableFIFORollover(void) {
...
void SG34::setPROXINTTHRESH(uint8_t val) {
...
void SG34::setup(byte powerLevel, byte sampleAverage, byte ledMode, int sampleRate, int pulseWidth, int adcRange) {
...
uint32_t SG34::getFIFORed(void)
{
  return (sense.red[sense.tail]);
}

//Report the next IR value in the FIFO
uint32_t SG34::getFIFOIR(void)
{
  return (sense.IR[sense.tail]);
}

//Report the next Green value in the FIFO
uint32_t SG34::getFIFOGreen(void)
{
  return (sense.green[sense.tail]);
}

//Advance the tail
void SG34::nextSample(void)
{
...
bool SG34::safeCheck(uint8_t maxTimeToCheck)
{
...
void SG34::bitMask(uint8_t reg, uint8_t mask, uint8_t thing)
{
